...
<!-- Header Start -->
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<h1 class="page-header-fixed">All Job Requests</h1>
		<div class="row placeholders">
			<%
			if(allJobRequestList.size()!=0)
			{
				for (int i = 0; i < allJobRequestList.size(); i++) {
					JobRequest i_CurrentJobRequest = (JobRequest) allJobRequestList.get(i);
			...
			<div class="col-md-3">
				<div class="thumbnail">
					<img src="../view/image_icons/Movie.jpg" class="img-responsive"
						...
						<h3>
						<%
							out.print(i_CurrentJobRequest.getId() + " "
										+ i_CurrentJobRequest.getNameOfJob());
						%>
					</h3>
					<h3>
						<%
							out.print(i_CurrentJobRequest.getStatus());
						%>
					</h3>
					<h5>
						<%
							out.print(i_CurrentJobRequest.getFreeLancerName());
						%>
					</h5>
					<h5>
						<%
							out.print(i_CurrentJobRequest.getFinishDate());
						%>
					</h5>
					<a href="../controller/viewCurrentJobRequest?currentJobRequestID=<%out.print(i);%>&Username=<%//out.print(currentUser);%>"
