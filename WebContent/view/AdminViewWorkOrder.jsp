        ...
        <select class="selectpicker" data-width="100%" name="Status">
       		 <optgroup label="Source Language">
        		     <option>Status</option>
     		         ...
     		         <select class="selectpicker" data-width="100%" name="ClientGet">
              ...
              <input class="btn-primary" type="submit" name="action1" value="Delete" onclick="alert('Delete Work Order'); return true" />
      </form>
      </div>
      </div>
